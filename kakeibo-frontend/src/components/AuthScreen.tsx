          ...
          {!isForgotPassword && (
            <div className="mt-4">
              <button
                ...
                className={`w-full py-[15px] px-6 rounded-[14px] transition-all duration-200 font-bold text-[16px] active:scale-[0.98] flex items-center justify-center gap-3 ${
                  isDarkMode
                    ? "bg-[#252529] hover:bg-[#323236] text-white active:bg-[#3d3d41]"
