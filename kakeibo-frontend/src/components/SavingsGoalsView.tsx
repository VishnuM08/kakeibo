    ...
    >
      <div className="max-w-lg mx-auto px-5 py-6">
        ...
        {isAddingGoal && (
          ...
          >
            <div
              className={`rounded-[28px] w-full max-w-md mx-5 p-6 ${isDarkMode ? "bg-[#1c1c1e]" : "bg-white"}`}
              onClick={(e) => e.stopPropagation()}
            >
              <h3
                className={`text-[24px] font-bold mb-4 ${isDarkMode ? "text-white" : "text-black"}`}
              >
                New Savings Goal
              </h3>
        ...
        {goals.length === 0 ? (
          <div
            className={`rounded-[20px] p-10 text-center ${isDarkMode ? "bg-[#1c1c1e]" : "bg-white"}`}
          >
            <Target
              className={`w-16 h-16 mx-auto mb-4 ${isDarkMode ? "text-white/20" : "text-black/20"}`}
            />
            <p
              className={`text-[17px] mb-2 ${isDarkMode ? "text-white" : "text-black"}`}
            >
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex-1">
                      <h3
                        className={`text-[20px] font-bold mb-1 ${isDarkMode ? "text-white" : "text-black"}`}
                      >
                        {goal.name}
                      </h3>
                  ...
                  <div className="mb-3">
                    ...
                    <div
                      className={`w-full h-3 rounded-full overflow-hidden ${isDarkMode ? "bg-white/10" : "bg-black/5"}`}
                    >
                      <div
                    ...
                    <p
                      className={`text-[13px] mt-1 ${isDarkMode ? "text-white/50" : "text-black/50"}`}
                    >
