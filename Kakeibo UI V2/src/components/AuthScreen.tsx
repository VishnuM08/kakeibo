...
export function AuthScreen({ onAuthSuccess, isDarkMode = false }: AuthScreenProps) {
  ...
  return (
    <div className={`min-h-screen flex items-center justify-center px-5 ${
      ...
      <div className="w-full max-w-md">
        ...
        {/* Auth Form */}
        <div className={`rounded-[28px] p-8 shadow-lg ${
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                >
                  {showPassword ? (
                    <EyeOff className={`w-5 h-5 ${isDarkMode ? 'text-white/40' : 'text-black/40'}`} />
                  ) : (
                    <Eye className={`w-5 h-5 ${isDarkMode ? 'text-white/40' : 'text-black/40'}`} />
                  )}
                </button>
              </div>
            </div>
          ...
          {/* Demo Credentials */}
          <div className={`mt-6 p-4 rounded-[12px] ${
            ...
            <p className={`text-[13px] ${
              ...
              Use any email & password to try the app (backend not connected yet)
            </p>
          </div>
        </div>
