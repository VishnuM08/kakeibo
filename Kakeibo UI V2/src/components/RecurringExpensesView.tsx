      ...
      >
        ...
        >
          ...
          <div className="px-5 pb-4">
            <div
              className={`p-4 rounded-[14px] bg-gradient-to-br ${
                isDarkMode
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <p
                  className={`text-[13px] font-medium ${isDarkMode ? "text-blue-400" : "text-blue-600"}`}
                >
                  Monthly Projection
                </p>
                <TrendingUp
              ...
              <p
                className={`text-[32px] font-bold ${isDarkMode ? "text-white" : "text-black"}`}
              >
...
function AddRecurringExpenseModal({
  expense,
  onClose,
  onSave,
  isDarkMode,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newExpense: RecurringExpense = {
      ...
      nextOccurrence:
        ...
        calculateNextOccurrence(startDate, frequency),
