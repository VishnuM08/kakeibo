...
export function AnalyticsView({ expenses, onClose, isDarkMode }: AnalyticsViewProps) {
    ...
    <div className={`fixed inset-0 z-50 overflow-y-auto ${isDarkMode ? 'bg-[#121212]' : 'bg-[#f5f5f7]'}`}>
      <div className="max-w-lg mx-auto px-5 py-6">
        ...
        <div className="grid grid-cols-2 gap-3 mb-5">
          <div className={`rounded-[16px] p-4 shadow-sm ${
            ...
            <p className={`text-[28px] font-bold ${isDarkMode ? 'text-white' : 'text-black'}`}>
        ...
        {/* Category Breakdown */}
        <div className={`rounded-[20px] p-5 shadow-sm mb-5 ${
          isDarkMode ? 'bg-[#1c1c1e]' : 'bg-white'
        }`}>
          <div className="flex items-center gap-2 mb-5">
            <PieChart className={`w-5 h-5 ${isDarkMode ? 'text-white' : 'text-black'}`} strokeWidth={2.5} />
