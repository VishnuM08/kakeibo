...
export async function getExpenses(): Promise<BackendExpense[]> {
  ...
  console.log("[API] Get expenses response: guys ", response.data);
  return response.data;
}
...
export async function getCurrentBudget(): Promise<Budget | null> {
  ...
  console.log("[API] Get current budget response:", response.data);
  return response.data;
} //   // TODO: Replace with actual API call
...
export async function setBudget(amount: number) {
  const response = await api.post("/budget", { monthlyAmount: amount });
  console.log("[API] Set budget response:", response.data);
  return response.data;
}
 ...
 */
//  `2vre2ee export async function setUserPin(pin: string): Promise<void> {
//   // TODO: Replace with actual API call
