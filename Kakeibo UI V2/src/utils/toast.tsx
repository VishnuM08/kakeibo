...
export const toastMessages = {
  ...
  // Savings goals
  goalCreated: () =>
    toast.success("Goal created!", "Start saving towards your goal"),
  goalUpdated: () =>
  ...
  registerSuccess: () =>
    toast.success("Account created!", "Welcome to Kakeibo"),

  // Sync messages
  syncSuccess: () =>
    toast.success("Synced!", "Your data has been synchronized"),
  syncError: () =>
    toast.error(
      "Sync failed",
  ...
  offlineMode: () =>
    toast.info("Offline mode", "Working offline - changes will sync later"),
